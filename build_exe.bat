...
"%PYINSTALLER_EXE%" --clean --noconfirm --noconsole --onefile --icon="media/bonkscanner_icon.ico" --name "BonkScanner" --hidden-import unicodedata --add-data "media/bonkscanner_icon.ico;media" --add-data "media/settings_icon.png;media" --add-data "media/bonkscanner_icon2.png;media" --add-data "media/checkmark.svg;media" --add-data "media/patreon_logo.svg;media" --add-data "media/kofi_logo.svg;media" --add-data "docs/help/help_ru.txt;docs/help" --add-data "docs/help/help_eng.txt;docs/help" --add-data "docs/help/help_ukr.txt;docs/help" --add-binary "%HOOK_PUBLISH_DIR%\*.dll;%HOOK_PUBLISH_DIR%" main.py
