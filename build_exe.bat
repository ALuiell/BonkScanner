...
"%PYINSTALLER_EXE%" --clean --noconfirm --noconsole --onefile --icon="media/bonkscanner_icon.ico" --name "BonkScanner_test" --hidden-import unicodedata --add-data "media/bonkscanner_icon.ico;media" --add-data "media/settings_icon.png;media" --add-data "media/bonkscanner_icon2.png;media" --add-data "media/checkmark.svg;media" --add-data "media/patreon_logo.svg;media" --add-data "media/kofi_logo.svg;media" --add-binary "%HOOK_PUBLISH_DIR%\*.dll;%HOOK_PUBLISH_DIR%" main.py
