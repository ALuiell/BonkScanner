...
Memory reading is handled by the `ProcessMemory` class in [src/infra/memory/reader.py](../../src/infra/memory/reader.py). It uses native Windows APIs to hook into the game process:
