"""Projection of runtime state into the VOD capture contract."""
...
def build_vod_capture_payload(
    runtime: RuntimeStateSnapshot,
    *,
    chaos_tome: Any = None,
) -> VodCapturePayload | None:
    ...
    return VodCapturePayload(
        ...
        mob_kills=(runtime.mob_kills if runtime.mob_kills is not None else snapshot.mob_kills),
        ...
        expected_key_procs=(chests.expected_key_procs if chests.expected_complete else None),
