...
from PySide6.QtWidgets import QComboBox, QGroupBox, QLineEdit, QListWidget, QPushButton, QSlider, QTabWidget, QWidget
from gui_shared import _make_scroll_section
from gui_styles import ITEM_SORT_LABELS
# Shared layout helpers. They stay in gui_layout because _build_compare_runs_tab
# still uses them there; gui_shared is their real home, but that is a separate move.
