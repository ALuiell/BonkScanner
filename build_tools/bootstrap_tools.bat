...
"%POWERSHELL_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%REPO_ROOT%\build_tools\bootstrap_dotnet.ps1"
if errorlevel 1 (
...
"%POWERSHELL_EXE%" -NoProfile -ExecutionPolicy Bypass -File "%REPO_ROOT%\build_tools\bootstrap_msvc.ps1"
if errorlevel 1 (
